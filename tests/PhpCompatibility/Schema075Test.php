...
final class Schema075Test extends AbstractCompatibilityTests
{
    ...
    protected string $attributeFormDefault = 'attributeFormDefault="qualified"';
    ...
    protected function expectXml(): string
    {
        ...
        <SOAP-ENV:Envelope xmlns:SOAP-ENV="http://schemas.xmlsoap.org/soap/envelope/" xmlns:tns="http://test-uri/"
            ...
            <SOAP-ENV:Body SOAP-ENV:encodingStyle="http://schemas.xmlsoap.org/soap/encoding/">
                <tns:test>
                    <testParam tns:int1="1" tns:int2="2" int3="3" xsi:type="tns:testType"/>
                </tns:test>
            </SOAP-ENV:Body>
        </SOAP-ENV:Envelope>
        XML;
